	...
	<div id="body">
		<span id="all">
			<span id="item">
				...
				<span class="item1"><a>Sports</a></span>
				<span class="item1"><a href="finance.do">Finance</a></span>
				...
				<span class="item1"><a href="https://epaper.timesgroup.com/TOI/TimesOfIndia/index.html?a=c">e-paper</a></span>
		                     ...
		                     <b><u><i><h1>    ::::: All updated news related to Sports ::::::		                    </h1> </b></u></i>    
...
<%try{
					...
					String query = "select Sno,Heading,Detail,link from sports";
...
<span> <a href="<%=rs.getString("link") %>">https://economictimes.indiatimes.com/news/economy/sports</a></span><br><br><hr>
